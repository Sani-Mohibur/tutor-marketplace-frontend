...
const STATIC_CARDS = [
  { id: "p1", name: "LinkedIn", desc: "Professional network for career growth, learning, and industry connections.", logo: "/logos/linkedin.svg" },
  { id: "p2", name: "Amazon Web Services", desc: "Cloud platform for building, deploying, and scaling modern applications.", logo: "/logos/aws.svg" },
  { id: "p3", name: "GitLab", desc: "DevSecOps platform for managing code, CI/CD, and software delivery.", logo: "/logos/gitlab.svg" },
  { id: "p4", name: "Hashnode", desc: "Community platform for developers to share knowledge and build tech blogs.", logo: "/logos/hashnode.svg" },
  { id: "p5", name: "DigitalOcean", desc: "Cloud platform for deploying, managing, and scaling modern applications.", logo: "/logos/digitalocean.svg" },
  { id: "p6", name: "Docker", desc: "Container platform for building, shipping, and running applications.", logo: "/logos/docker.svg" },
  { id: "p7", name: "Netlify", desc: "Modern web development platform for automating and hosting high-performance sites.", logo: "/logos/netlify.svg" },
  { id: "p8", name: "GitHub Education", desc: "Empowering the next generation of developers with industry-standard tools.", logo: "/logos/github.svg" },
  { id: "p9", name: "Postman", desc: "API platform for designing, testing, and managing modern APIs.", logo: "/logos/postman.svg" },
  { id: "p10", name: "HackerRank", desc: "Coding platform for practicing skills and preparing for technical interviews.", logo: "/logos/hackerrank.svg" },
];
...
function MarqueeCard({ card, idx }: any) {
  return (
    <div
      className={`
        relative w-[280px] shrink-0 rounded-2xl p-6
        border border-black/5 dark:border-white/10
        bg-gradient-to-b from-slate-50/60 via-slate-50/40 to-transparent
        dark:from-slate-950/60 dark:via-slate-950/40 dark:to-transparent
        ...
        hover:shadow-[0_20px_40px_rgba(16,185,129,0.1)]
        dark:hover:shadow-[0_20px_40px_rgba(59,130,246,0.1)]
        transition-all duration-500 ease-out
        group overflow-hidden select-none
        ${getFloatClass(idx)}
      `}
    >
      <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/5 via-transparent to-emerald-500/5 dark:from-blue-500/5 dark:to-blue-500/5 opacity-80" />

      <div className="relative flex flex-col items-center text-center gap-3">
        <img src={card.logo} alt={card.name} className="w-10 h-10 object-contain" />
        <div>
          <h3 className="text-sm font-bold text-foreground">{card.name}</h3>
          <p className="text-xs text-muted-foreground leading-relaxed mt-2 h-12 overflow-hidden">
            {card.desc}
          </p>
        </div>
      </div>
    ...
    <section className="w-full py-24 bg-background overflow-hidden relative border-b border-black/5 dark:border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-4 mb-16 text-center md:text-left">
        ...
        <p className="mt-3 text-sm font-medium text-muted-foreground max-w-xl leading-relaxed mx-auto md:mx-0">
          Partnering with leading technology and learning platforms to deliver a faster, smarter, and more engaging tutoring experience for learners and educators worldwide.
        </p>
      </div>
