            ...
            {systemCategories.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center justify-between p-3 rounded-xl border text-left text-xs font-semibold tracking-wide transition-all duration-200 cursor-pointer ${isSelected
